    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md shadow-elevated">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription>Predict crop growth & profitability before investing</CardDescription>
        </CardHeader>
        <CardContent>
          {showForgot ? (
            ...
            <Tabs defaultValue="login" className="space-y-4">
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                      <Input id="signup-password" name="password" type="password" required minLength={6} className="pl-9" placeholder="••••••••" />
                    </div>
                  </div>
                  <Button type="submit" className="w-full" disabled={loading}>
              ...
              <Button variant="outline" className="w-full" onClick={() => lovable.auth.signInWithOAuth("google")} disabled={loading}>
